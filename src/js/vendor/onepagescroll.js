...
function onePageScroll(element, options) {
  ...
  _root.init = function() {
    ...
    /*-------------------------------------------*/
  	...
  	if(_root.location.hash != "" && _root.location.hash != "#1") {
  		var init_index =  _root.location.hash.replace("#", ""),
  		...
  		if(next) {
  			...
  			if (history.replaceState && settings.updateURL == true) {
  				var href = _root.location.href.substr(0,_root.location.href.indexOf('#')) + "#" + (init_index);
      ...
      var page_index = _root.dataset.index;
  ...
  /*---------------------------------*/
   ...
   _root.moveDown = function(el3) {
    ...
    var index = document.querySelector(settings.sectionContainer +".active").dataset.index,
		...
		if (history.replaceState && settings.updateURL == true) {
			var href = _root.location.href.substr(0,_root.location.href.indexOf('#')) + "#" + (parseInt(index) + 1);
			history.pushState( {}, document.title, href );
		}
  ...
  _root.moveTo = function(el5, page_index) {
    ...
    if (typeof el5 == "string") el5 = document.querySelector(el5);
		...
		if(next) {
		  var next_index = next.dataset.index;
			...
			if (history.replaceState && settings.updateURL == true) {
				var href = _root.location.href.substr(0,_root.location.href.indexOf('#')) + "#" + (parseInt(page_index));
				history.pushState( {}, document.title, href );
			}
